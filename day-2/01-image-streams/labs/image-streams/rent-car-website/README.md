# Satos — Rent-a-Car Website

A landing page for a car rental service, served with **Node.js + Express** inside a Docker container.
...
└── src/
    ...
    └── main.js      # Client-side JS (nav toggle, booking buttons)
```
